...
@app.route('/api/todos')
def list_todos():
    """Returns JSON w/ all todos wit function in models.py"""
    all_todos = [todo.serialize()
                 for todo in Todo.query.all()]  # list comprehension
    return jsonify(todos=all_todos)  # key value pair in json
