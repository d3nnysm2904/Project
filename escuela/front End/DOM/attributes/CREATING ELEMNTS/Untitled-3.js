...
//APPEND
const ul =document.querySelector('ul');//select the first ul
 const newLi =document.createElement('li');//cretate li 

newLi.innerText='I am new li'
ul.append(newLi)

const.secondTodos=document.createElement('li')
secondTodos.innerText='what is className'
secondTodos.className='todo'
